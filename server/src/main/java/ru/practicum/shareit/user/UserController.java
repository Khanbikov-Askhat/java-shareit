...
public class UserController {
    ...
    @PostMapping
    public UserDto userDtoCreateResponse(@RequestBody UserDto userDto) {
        log.info("пришел POST запрос /users с телом: {}", userDto);
        return userService.create(userDto);
    }

    @PatchMapping(value = "/{userId}")
    public UserDto userDtoUpdateResponse(@RequestBody UserDto userDto, @PathVariable Long userId) {
