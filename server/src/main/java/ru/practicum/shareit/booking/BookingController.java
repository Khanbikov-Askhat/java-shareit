...
public class BookingController {
    ...
    @PostMapping
    public BookingResponse createBookingOutDtoResponse(@RequestBody BookingRequest bookingRequest,
    ...
    public List<BookingResponse> findBookingsOutDtoOfOwnerResponse(@RequestParam(defaultValue = "ALL", required = false) String state,
                                                   @RequestHeader("X-Sharer-User-Id") Long userId, @RequestParam(defaultValue = "0") int from,
                                                                   @RequestParam(defaultValue = "10") int size) {
